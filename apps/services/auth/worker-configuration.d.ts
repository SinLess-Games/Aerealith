/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 471faf92c5f76a96b36f69d1a52b386f)
// Runtime types generated with workerd@1.20260730.1 2026-07-28 nodejs_compat
interface __BaseEnv_Env {
  DATABASE_URL: SecretsStoreSecret;
  RESEND_API_KEY: SecretsStoreSecret;
  FLAGSHIP_FLAGS: Flagship;
  AUTH_SENSITIVE_RATE_LIMIT: RateLimit;
  NODE_ENV: 'development' | 'production';
  FRONTEND_URL: 'http://localhost:4200' | 'https://aerealith.com';
  OTEL_EXPORTER_OTLP_HEADERS?: SecretsStoreSecret;
  PROMETHEUS_TOKEN?: SecretsStoreSecret;
  LOKI_TOKEN?: SecretsStoreSecret;
  TEMPO_TOKEN?: SecretsStoreSecret;
  RESEND_FROM_EMAIL?: 'Aerealith <auth@example.com>';
  ...
  PROMETHEUS_METRICS_URL?: 'https://prometheus-prod-67-prod-us-west-0.grafana.net/api/prom/push';
  PROMETHEUS_USER_ID?: '3406144';
  LOKI_LOGGING_URL?: 'https://logs-prod-021.grafana.net';
  LOKI_NAME?: 'grafanacloud-sinlessindustries-logs';
  LOKI_USER_ID?: '1698747';
  TEMPO_TRACING_URL?: 'https://tempo-prod-15-prod-us-west-0.grafana.net/tempo';
  TEMPO_NAME?: 'grafanacloud-sinlessindustries-traces';
  TEMPO_USER_ID?: '1693048';
