/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/frontend/wrangler.toml apps/frontend/worker-configuration.d.ts` (hash: f7d6b73e13c4f27e6bef7a9bf62da8d2)
