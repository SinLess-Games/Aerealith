/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2c638c942f96ca7626f4b6186a0031a6)
// Runtime types generated with workerd@1.20260730.1 2026-07-08 nodejs_compat
interface __BaseEnv_Env {
  AEREALITH_KV: KVNamespace;
  AEREALITH_AI: R2Bucket;
  AEREALITH_ANALYTICS: AnalyticsEngineDataset;
  EVENTBUS: Queue;
  NOTIFICATION_QUEUE: Queue;
  FLAGSHIP_FLAGS: Flagship;
  ASSETS: Fetcher;
  API_SERVICE_URL: 'https://aerealith-api-preview.sinless-deploy.workers.dev';
  ...
  VITE_CLOUDFLARE_WEB_ANALYTICS_ENABLED: 'false';
  VITE_CLOUDFLARE_WEB_ANALYTICS_TOKEN: '';
  API_WORKER: Fetcher /* aerealith-api */;
  AUTH_WORKER: Fetcher /* aerealith-auth */;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | 'VITE_GTM_CONTAINER_ID'
      | 'VITE_ADSENSE_CLIENT_ID'
      | 'VITE_ADSENSE_TEST_MODE'
      | 'VITE_TURNSTILE_SITE_KEY'
      | 'VITE_GOOGLE_SITE_VERIFICATION'
      | 'VITE_CLOUDFLARE_WEB_ANALYTICS_ENABLED'
      | 'VITE_CLOUDFLARE_WEB_ANALYTICS_TOKEN'
    >
  > {}
}
