/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/frontend/wrangler.toml apps/frontend/worker-configuration.d.ts` (hash: 6b2666f772915e8c7dc143a0a2ed3c7f)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'API_SERVICE_URL'>
  > {}
}
