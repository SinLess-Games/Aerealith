...
| `apps/services/api/**`                                                          | Core backend API service                                 | AGPL-3.0-only                                                                           |
| `apps/services/auth/**`                                                         | Core authentication service                              | AGPL-3.0-only                                                                           |
| `libs/api-platform/**`                                                          | Shared API platform implementation                       | AGPL-3.0-only                                                                           |
| `libs/auth/**`                                                                  | Shared authentication implementation                     | AGPL-3.0-only                                                                           |
| `libs/authorization/**`                                                         | Shared authorization and RBAC implementation             | AGPL-3.0-only                                                                           |
...
| `libs/observability/**`                                                         | Shared observability and telemetry implementation        | AGPL-3.0-only                                                                           |
