// libs/content/src/en/home/faq.section.ts

import type { HomeFaqCardItem, HomeFaqSectionContent } from '../../types'
 ...
 * @decorator content
 */
export type FaqCardItem = HomeFaqCardItem
 ...
 * @decorator section
 */
export type FaqSectionContent = HomeFaqSectionContent
...
export const faqCards = [
  ...
  {
    id: 'faq-integrations',
    question: 'What apps will Aerealith connect to?',
    answer:
      'The long-term goal is for Aerealith to integrate with thousands of apps, tools, services, platforms, and systems through secure, scoped connections. Aerealith is being designed to support developer tools, community platforms, cloud services, dashboards, automations, files, communication apps, productivity suites, infrastructure systems, and future device integrations. Instead of locking users into a small set of fixed connections, Aerealith will grow into a flexible integration layer where users can choose what to connect, what permissions to grant, and how those tools should work together.',
    tag: 'Anonymous',
    title: 'What apps will Aerealith connect to?',
    description:
      'The long-term goal is for Aerealith to integrate with thousands of apps, tools, services, platforms, and systems through secure, scoped connections. Aerealith is being designed to support developer tools, community platforms, cloud services, dashboards, automations, files, communication apps, productivity suites, infrastructure systems, and future device integrations. Instead of locking users into a small set of fixed connections, Aerealith will grow into a flexible integration layer where users can choose what to connect, what permissions to grant, and how those tools should work together.',
  },
  {
    id: 'faq-self-hosting',
    question: 'Will Aerealith support self-hosting?',
    answer:
    ...
    tag: 'Anonymous',
    title: 'Will Aerealith support self-hosting?',
    description:
      'Self-hosting and air-gapped deployment support are part of the long-term platform direction, especially for teams, businesses, infrastructure operators, and enterprise environments that need stronger control over data, security, compliance, and deployment boundaries.',
  },
...
export const faqSection = {
  ...
  title: 'FAQ',
  description:
    'Common early questions from users, supporters, developers, communities, and potential investors as Aerealith moves through active development, MVP testing, pricing refinement, integration planning, and early public launch preparation.',
  body: 'Aerealith is still in active development, so this section will grow as the MVP ships, pricing is refined, integrations are added, and early users begin testing the platform. As new features move from planning to production, the FAQ will be updated with clearer answers about availability, data ownership, memory controls, automation limits, supported integrations, crowdfunding, billing, security, and the long-term roadmap.',
