...
describe('Button', () => {
  ...
  it('uses the primary variant by default', () => {
    ...
    expect(
      button.classList.contains('text-[var(--ae-primary-foreground)]'),
    ).toBe(true);
  });
  ...
  it('uses the semantic contrast foreground for destructive actions', () => {
    render(<Button variant="danger">Delete account</Button>);

    expect(
      screen
        .getByRole('button', { name: 'Delete account' })
        .classList.contains('text-[var(--ae-danger-contrast)]'),
    ).toBe(true);
  });
