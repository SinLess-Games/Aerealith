...
exports.AuthErrorCodeValues = exports.AuthErrorCode = void 0;
...
exports.AuthErrorCodeValues = Object.values(exports.AuthErrorCode);
function isAuthErrorCode(value) {
  return (
    typeof value === 'string' && exports.AuthErrorCodeValues.includes(value)
  );
}
