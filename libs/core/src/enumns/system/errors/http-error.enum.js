...
exports.HttpErrorCodeValues = exports.HttpErrorCode = void 0;
exports.isHttpErrorCode = isHttpErrorCode;
exports.getHttpError = getHttpError;
exports.getHttpErrorByStatus = getHttpErrorByStatus;
/**
...
exports.HttpErrorCodeValues = Object.values(exports.HttpErrorCode).map(
  ({ statusCode }) => statusCode,
);
function isHttpErrorCode(value) {
  return (
    typeof value === 'number' && exports.HttpErrorCodeValues.includes(value)
  );
}
function getHttpError(code) {
  return exports.HttpErrorCode[code];
}
function getHttpErrorByStatus(statusCode) {
  return Object.values(exports.HttpErrorCode).find(
    (error) => error.statusCode === statusCode,
  );
}
//# sourceMappingURL=http-error.enum.js.map
