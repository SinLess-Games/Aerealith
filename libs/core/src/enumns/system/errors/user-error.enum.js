...
exports.UserErrorCodeValues = exports.UserErrorCode = void 0;
exports.isUserErrorCode = isUserErrorCode;
/**
...
exports.UserErrorCodeValues = Object.values(exports.UserErrorCode);
function isUserErrorCode(value) {
  return (
    typeof value === 'string' && exports.UserErrorCodeValues.includes(value)
  );
}
//# sourceMappingURL=user-error.enum.js.map
