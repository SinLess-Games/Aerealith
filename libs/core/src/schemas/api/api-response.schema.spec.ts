...
describe('apiErrorResponseSchema', () => {
  const UserErrorCodeSchema = z.enum(['USER_NOT_FOUND', 'USER_ALREADY_EXISTS'])

  const UserErrorResponseSchema = apiErrorResponseSchema(UserErrorCodeSchema)
...
describe('apiResponseSchema', () => {
  ...
  const UserResponseSchema = apiResponseSchema(UserSchema, UserErrorCodeSchema)
