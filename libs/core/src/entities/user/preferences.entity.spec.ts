...
describe('UserPreferencesEntity', () => {
  ...
  it('creates preferences with safe defaults', () => {
    ...
    expect(preferences.nameDisplayOrder).toBe(NameDisplayOrder.LocaleDefault)
    expect(preferences.measurementSystem).toBe(MeasurementSystem.Metric)
    expect(preferences.contentMaturity).toBe(ContentMaturity.FamilyFriendly)
  })
  ...
  it('updates updatedAt when preferences change', () => {
    ...
    expect(preferences.updatedAt).toEqual(new Date('2026-06-20T12:10:00.000Z'))
  })
  ...
  it('keeps soft-delete behavior from BaseEntity', () => {
    ...
    expect(preferences.deletedAt).toEqual(new Date('2026-06-20T12:20:00.000Z'))
    expect(preferences.updatedAt).toEqual(new Date('2026-06-20T12:20:00.000Z'))
  })
})
