...
describe('UserProfileEntity', () => {
  ...
  it('updates a single field visibility override', () => {
    ...
    profile.setFieldVisibility('bio', ProfileFieldVisibility.Private)
  ...
  it('updates only supplied text profile fields', () => {
    const profile = new UserProfileEntity({
      userId: 'user-id',
      handle: 'andy',
      displayName: 'Andy',
  ...
  it('updates profile state, personal details, and collections', () => {
    const profile = new UserProfileEntity({
      userId: 'user-id',
      handle: 'andy',
      locationLabel: 'Boise',
    ...
    profile.update({
      ...
      websiteUrl: '  https://aerealith.com/profile  ',
      links: [
        {
          platform: 'github',
          url: '  https://github.com/sinless777/aerealith  ',
          label: '  Aerealith  ',
        },
      ],
    })
    ...
    expect(profile.locationLabel).toBe('Twin Falls, Idaho')
    ...
    expect(profile.websiteUrl).toBe('https://aerealith.com/profile')
  ...
  it('updates updatedAt when profile data changes', () => {
    ...
    expect(profile.updatedAt).toEqual(new Date('2026-06-20T12:10:00.000Z'))
  })
  ...
  it('keeps soft-delete behavior from BaseEntity', () => {
    ...
    expect(profile.deletedAt).toEqual(new Date('2026-06-20T12:20:00.000Z'))
    expect(profile.updatedAt).toEqual(new Date('2026-06-20T12:20:00.000Z'))
  })
})
