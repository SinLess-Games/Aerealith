...
function createUserPreferencesRow(
  ...
  return {
    ...
    timezoneGreenwich:
      'GMT-06:00' as UserPreferencesRow['timezoneGreenwich'],
    ...
    nameDisplayOrder:
      'given_family' as UserPreferencesRow['nameDisplayOrder'],
    measurementSystem:
      'imperial' as UserPreferencesRow['measurementSystem'],
    contentMaturity:
      'standard' as UserPreferencesRow['contentMaturity'],
...
describe('user preferences mapper', () => {
  ...
  it('preserves locale and timezone preferences through every mapper boundary', () => {
    const row = createUserPreferencesRow({
      ...
      timezoneGreenwich:
        'GMT-04:00' as UserPreferencesRow['timezoneGreenwich'],
    });
  ...
  it('preserves display and content preferences through every mapper boundary', () => {
    const row = createUserPreferencesRow({
      ...
      measurementSystem:
        'metric' as UserPreferencesRow['measurementSystem'],
      contentMaturity:
        'mature' as UserPreferencesRow['contentMaturity'],
    });
