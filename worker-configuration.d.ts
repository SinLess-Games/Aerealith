/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/services/api/wrangler.toml` (hash: 4c599754dbef9b9e8ce95c0dfa5c6160)
...
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./apps/services/api/src/worker');
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'NODE_ENV' | 'FRONTEND_URL'>
  > {}
}
