/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/frontend/wrangler.toml` (hash: fc9b494870ea6cd39eb28d018fa47fd1)
// Runtime types generated with workerd@1.20260617.1 2026-07-03
interface __BaseEnv_Env {
  PLATFORM_KV: KVNamespace
  AEREALITH_R2: R2Bucket
  POSTGRES_URL: SecretsStoreSecret
  PREVIEW_POSTGRES_URL: SecretsStoreSecret
  STAGING_POSTGRES_URL: SecretsStoreSecret
  PRODUCTION_POSTGRES_URL: SecretsStoreSecret
...
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./apps/frontend/src/worker')
  }
