/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/services/auth/wrangler.toml` (hash: ccd0e76db9c7de893816834cb1f714f2)
// Runtime types generated with workerd@1.20260708.1 2026-07-28 nodejs_compat
interface __BaseEnv_Env {
  DATABASE_URL: SecretsStoreSecret;
  RESEND_API_KEY: SecretsStoreSecret;
  FLAGSHIP_FLAGS: Flagship;
  NODE_ENV: 'production';
  FRONTEND_URL: 'https://aerealith.com';
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./apps/services/auth/src/worker');
  }
